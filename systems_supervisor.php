<?php
    ...
    $table2="empleados";
    $table3="subprocesos";
    $fields="empleados.nombre_completo, sistemas.nombre_sistema, subprocesos.nombre, sistemas.observaciones";
    $ONclause1="sistemas.cedula=empleados.cedula";
    $ONclause2="subprocesos.id=empleados.id";
    $whereClause="sistemas.estado = 1";
	...
	<div class = "row justify-content-center my_row">
		...
		<div class = "row justify-content-center my_row">
			<div class = "col-12 my_col">
					<!--(row_!Titulo!)-->
					<p class="text-center">Sistemas SFI:</p>
			</div>
		</div>
                ...
                <table id="myTable" class="table table-borderless table-hover" style="width:100%">
                    <thead class="thead-dark">    
                        <tr>
                            ...
                            <th><small>Obervaciones:</small></th>
                        </tr>
                    </thead>
                    <tbody>
