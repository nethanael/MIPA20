		...
		<div class="row justify-content-center my_row">
            ...
            <div class="col my_col">
                ...
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <p class="card-text">Este es un sistema de control y seguimiento del personal del proceso de SFI</p>
                	</div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Desarrollado por: <b>Ing. Pablo Hidalgo Acu&ntildea</b></li>
                    </ul>
					<ul class="list-group list-group-flush">
                        <li class="list-group-item">Diseñado por: <b>Ing. Carlos Rojas</b></li>
                    </ul>
                </div>
			</div>
