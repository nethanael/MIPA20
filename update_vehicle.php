<?php
    ...
    $placa = $_POST['placa'];
    $numero_SAP = $_POST['numero_SAP'];
    $zona_atendida = $_POST['zona_atendida'];
    $CMA = $_POST['CMA'];
    $tipo = $_POST['tipo'];
    $ano = $_POST['ano'];
    $asignado_a = $_POST['asignado_a'];
    $estado_extintor = $_POST['estado_extintor'];
    $extintor_cod_SAP = $_POST['extintor_cod_SAP'];
    $numero_vale = $_POST['numero_vale'];
    $observaciones = $_POST['observaciones'];
    $para_sustituir = $_POST['para_sustituir'];
    $prioridad_sustitucion = $_POST['prioridad_sustitucion'];
    $activo = $_POST['activo'];

    // Definimos los campos y los valores a actualizar
    $table = "vehiculos";

    $fields = "numero_SAP = '$numero_SAP',
        zona_atendida = '$zona_atendida',
        CMA = '$CMA',
        tipo = '$tipo',
        ano = '$ano',
        asignado_a = '$asignado_a',
        estado_extintor = '$estado_extintor',
        extintor_cod_SAP = '$extintor_cod_SAP',
        numero_vale = '$numero_vale',
        observaciones = '$observaciones',
        para_sustituir = '$para_sustituir',
        prioridad_sustitucion = '$prioridad_sustitucion',
        activo = $activo"; // Si quieres marcarlo como activo

    // Condición para ubicar el registro
    $whereClause = "placa = '$placa'";

    // Ejecutamos el query
    $result = db_update_query_1_whereClause($table, $fields, $whereClause);

    // Verificación del resultado (puedes adaptar según retorno de tu función)
    if ($result) {
        $mensaje_resultado= "Actualización exitosa.";
        // o redirigir: header("Location: vehicles_supervisor.php?status=success");
    } else {
        $mensaje_resultado= "Error al actualizar el vehículo.";
    }
			...
			<div class = "col-12 my_col">
                ...
                <form method="" action="">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="numero_SAP" name="numero_SAP" value="<?php echo $numero_SAP;?>"readonly><br>
                        
                        <label for="fname">Zona que atiende:</label><br>
                        <input type="text" class="form-control" id="zona_atendida" name="zona_atendida" value="<?php echo $zona_atendida;?>"readonly><br>
                        
                        <label for="fname">CMA:</label><br>
                        <input type="text" class="form-control" id="CMA" name="CMA" value="<?php echo $CMA;?>"readonly><br>
                        
                        <label for="fname">Tipo:</label><br>
                        <input type="text" class="form-control" id="tipo" name="tipo" value="<?php echo $tipo;?>"readonly><br>
                        
                        <label for="fname">A&ntildeo:</label><br>
                        <input type="text" class="form-control" id="ano" name="ano" value="<?php echo $ano;?>"readonly><br>
                        ...
                        <input type="text" class="form-control" id="asignado_a" name="asignado_a" value="<?php echo $asignado_a;?>"readonly><br>
                        ...
                        <input type="text" class="form-control" id="estado_extintor" name="estado_extintor" value="<?php echo $estado_extintor;?>"readonly><br>
                    
                        <label for="lname">Extintor Cod. SAP:</label><br>
                        <input type="text" class="form-control" id="extintor_cod_SAP" name="extintor_cod_SAP" value="<?php echo $extintor_cod_SAP;?>"readonly><br>
           
                        <label for="lname">Vale:</label><br>
                        <input type="text" class="form-control" id="numero_vale" name="numero_vale" value="<?php echo $numero_vale;?>"readonly><br>
                    
                        <label for="lname">Observaciones:</label><br>
                        <small class="form-text text-muted">Acepta 300 caracteres.</small><br>
                        <input type="text" class="form-control" id="observaciones" name="observaciones" value="<?php echo $observaciones;?>"readonly><br>
                        ...
                        <input type="text" class="form-control" id="activo" name="activo" value="<?php echo $activo;?>"readonly><br>
                    </div>
